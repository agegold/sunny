...
class CAR:
  ...
  KIA_BONGO_EV = "KIA BONGO EV20213"
  K7_2020_NON_SCC = "KIA K7 2020-"
  K5_2021_NON_SCC = "KIA K5 2021"
...
CHECKSUM = {
  "crc8": [CAR.SANTA_FE, CAR.SONATA, CAR.PALISADE, CAR.KIA_SELTOS, CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021, CAR.SONATA_HYBRID, CAR.SANTA_FE_2022, CAR.KIA_K5_2021, CAR.SANTA_FE_HEV_2022, CAR.ELANTRA_2022_NON_SCC, CAR.CAR.K5_2021_NON_SCC],
...
EV_CAR = set([CAR.IONIQ_EV_2020, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.KIA_NIRO_EV, CAR.KIA_BONGO_EV])
...
DBC = {
  ...
  CAR.K7_2020_NON_SCC: dbc_dict('hyundai_kia_generic', None),
  CAR.K5_2021_NON_SCC: dbc_dict('hyundai_kia_generic', None),
}
