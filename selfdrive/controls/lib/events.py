...
def startup_master_alert(CP: car.CarParams, CS: car.CarState, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return StartupAlert("WARNING: This branch is not tested", alert_status=AlertStatus.userPrompt)
...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.keepHandsOnWheel: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("운전자가 핸들을 잡아야 합니다."),
  },
  ...
  EventName.plannerErrorDEPRECATED: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("플래서 솔루션 오류"),
    ET.NO_ENTRY: NoEntryAlert("플래서 솔루션 오류"),
  },
