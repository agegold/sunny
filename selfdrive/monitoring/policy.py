...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self):
    ...
    self._WHEELTOUCH_POLICY_ALERT_1_TIMEOUT = 9999.   #15
    self._WHEELTOUCH_POLICY_ALERT_2_TIMEOUT = 9999.   #24.
    self._WHEELTOUCH_POLICY_ALERT_3_TIMEOUT = 9999    #30.
    # https://cdn.euroncap.com/cars/assets/euro_ncap_protocol_safe_driving_driver_engagement_v11_a30e874152.pdf
    self._VISION_POLICY_ALERT_1_TIMEOUT = 9999.  #3
    self._VISION_POLICY_ALERT_2_TIMEOUT = 9999.  #5
    self._VISION_POLICY_ALERT_3_TIMEOUT = 9999. #11
